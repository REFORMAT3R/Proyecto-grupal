...
visualizar los trajes disponibles y realizar reservas mediante un formulario conectado a una base de datos. 
El sistema está diseñado con una interfaz atractiva, validaciones en el formulario, animaciones e interacción
 con el usuario, y un backend funcional para el almacenamiento de la información.
...
- **Python (Flask)** – backend y manejo de rutas  
- **SQL (PostgreSQL)** – base de datos para reservas  
- **Render** – hosting del proyecto  
